...
public class TerrestrialHabitatRecipe extends ModRecipe<TerrestrialHabitatRecipe> {
    ...
    public TerrestrialHabitatRecipe(Identifier id, ModRecipeData recipe) {
        super(id, recipe, SERIALIZER, TYPE);
    }

    @Override
    protected TerrestrialHabitatRecipe createInstance(Identifier id, ModRecipeData recipe) {
