...
public class TerrestrialHabitatScreen extends AbstractContainerScreen<TerrestrialHabitatMenu> {
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(Biotech.MOD_ID, "textures/gui/" + MachineRegistries.TERRESTRIAL_HABITAT.id() + ".png");
    ...
    protected void extractBackground(@NotNull GuiGraphicsExtractor g, int mouseX, int mouseY, float partialTick) {
        ...
        g.blit(RenderPipelines.GUI_TEXTURED, TEXTURE, leftPos + 88, topPos + 32, 212, 0, getProgressWidth() + 1, PROGRESS_HEIGHT, 256, 256);
        ...
        new BiotechItemRenderer(24, 24).render(g, leftPos + 128, topPos + 33, menu.getRecipe().getOutputItems()[0].getItemStack());
        new BiotechItemRenderer(24, 24).render(g, leftPos + 156, topPos + 33, menu.getRecipe().getOutputItems()[1].getItemStack());
