...
public class TerrestrialHabitatScreen extends AbstractContainerScreen<TerrestrialHabitatMenu> {
    ...
    protected void renderBg(@NotNull GuiGraphics g, float partialTick, int mouseX, int mouseY) {
        ...
        new BiotechItemRenderer(24,24).render(g.pose(), leftPos + 128, topPos + 33, menu.getRecipe().getOutputItems()[0].getItemStack());
        new BiotechItemRenderer(24,24).render(g.pose(), leftPos + 156, topPos + 33, menu.getRecipe().getOutputItems()[1].getItemStack());
