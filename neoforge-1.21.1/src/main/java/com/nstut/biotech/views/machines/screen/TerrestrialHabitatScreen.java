...
public class TerrestrialHabitatScreen extends AbstractContainerScreen<TerrestrialHabitatMenu> {
    ...
    protected void renderLabels(@NotNull GuiGraphics g, int mouseX, int mouseY) {
        ...
        if (menu.getIsOperating()) {
            ...
            if (isHovering(31, 131, 20, 20, mouseX, mouseY)) g.renderTooltip(font, List.of(Component.literal(recipe.getFluidIngredients()[0].getHoverName().getString())), Optional.empty(), mouseX - leftPos, mouseY - topPos);
