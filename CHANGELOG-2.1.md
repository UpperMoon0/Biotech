...
- Make NeoForge 26.1.2 fluid hatches support arbitrary fluid-capable containers in their GUI and through direct right-click interaction while preserving input/output directionality.
