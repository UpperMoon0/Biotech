...
public class FermenterScreen extends BiotechContainerScreen<FermenterMenu> {
    public FermenterScreen(FermenterMenu menu, Inventory inventory, Component title) { super(menu, inventory, title, BiotechStyle.MACHINE_WIDTH, BiotechStyle.MACHINE_HEIGHT); }
    @Override protected UIComponent buildUI() {
        ...
        return MachineUi.build(MachineUi.Kind.FERMENTER, title, display,
