...
public class SlaughterhouseScreen extends BiotechContainerScreen<SlaughterhouseMenu> {
    public SlaughterhouseScreen(SlaughterhouseMenu menu, Inventory inventory, Component title) { super(menu, inventory, title, BiotechStyle.MACHINE_WIDTH, BiotechStyle.MACHINE_HEIGHT); }
