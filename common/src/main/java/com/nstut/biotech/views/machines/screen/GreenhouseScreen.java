...
public class GreenhouseScreen extends BiotechContainerScreen<GreenhouseMenu> {
    public GreenhouseScreen(GreenhouseMenu menu, Inventory inventory, Component title) { super(menu, inventory, title, BiotechStyle.MACHINE_WIDTH, BiotechStyle.MACHINE_HEIGHT); }
    @Override protected UIComponent buildUI() {
        ...
        return MachineUi.build(MachineUi.Kind.GREENHOUSE, title, display,
