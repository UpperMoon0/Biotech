...
- Require OpenUI MC 0.0.10 or newer within the 0.0.x compatibility line on clients and pin source/CI builds to OpenUI main commit `90c515f643483f1690ea73c54745b06af9f21f61`.
...
- Exercise the largest Slaughterhouse recipe in the active preview with all four rabbit outputs, including the second output row and 13% Rabbit Foot chance label.
