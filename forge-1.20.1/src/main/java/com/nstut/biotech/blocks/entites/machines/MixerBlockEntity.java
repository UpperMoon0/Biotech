...
public class MixerBlockEntity extends MachineBlockEntity {
    ...
    public MultiblockPattern getMultiblockPattern() {
        MultiblockBlock b = new MultiblockBlock(Blocks.MUD_BRICKS, Map.of()),
                        c = new MultiblockBlock(Blocks.WARPED_STAIRS, Map.of("half", "bottom", "waterlogged", "false", "facing", "west")),
                        d = new MultiblockBlock(Blocks.WARPED_STAIRS, Map.of("half", "bottom", "waterlogged", "false", "facing", "south")),
                        e = new MultiblockBlock(Blocks.WARPED_STAIRS, Map.of("half", "bottom", "waterlogged", "false", "facing", "south")),
                        f = new MultiblockBlock(BlockRegistries.FLUID_OUTPUT_HATCH.get(), Map.of("facing", "east")),
                        g = new MultiblockBlock(Blocks.WARPED_STAIRS, Map.of("half", "bottom", "waterlogged", "false", "facing", "west")),
                        h = new MultiblockBlock(BlockRegistries.BIOTECH_MACHINE_CASING.get(), Map.of()),
                        i = new MultiblockBlock(Blocks.WARPED_STAIRS, Map.of("half", "bottom", "waterlogged", "false", "facing", "east")),
                        ...
                        l = new MultiblockBlock(Blocks.WARPED_STAIRS, Map.of("half", "bottom", "waterlogged", "false", "facing", "west")),
                        m = new MultiblockBlock(Blocks.WARPED_STAIRS, Map.of("half", "bottom", "waterlogged", "false", "facing", "north")),
                        n = new MultiblockBlock(Blocks.WARPED_STAIRS, Map.of("half", "bottom", "waterlogged", "false", "facing", "east")),
                        ...
                        u = new MultiblockBlock(Blocks.WARPED_STAIRS, Map.of("half", "top", "waterlogged", "false", "facing", "west")),
                        v = new MultiblockBlock(Blocks.WARPED_STAIRS, Map.of("half", "top", "waterlogged", "false", "facing", "south")),
                        w = new MultiblockBlock(Blocks.WARPED_STAIRS, Map.of("half", "top", "waterlogged", "false", "facing", "east")),
                        x = new MultiblockBlock(Blocks.WARPED_STAIRS, Map.of("half", "top", "waterlogged", "false", "facing", "west")),
                        y = new MultiblockBlock(Blocks.WARPED_PLANKS, Map.of()),
                        z = new MultiblockBlock(Blocks.WARPED_STAIRS, Map.of("half", "top", "waterlogged", "false", "facing", "east")),
                        aa = new MultiblockBlock(Blocks.WARPED_STAIRS, Map.of("half", "top", "waterlogged", "false", "facing", "west")),
                        ab = new MultiblockBlock(Blocks.WARPED_STAIRS, Map.of("half", "top", "waterlogged", "false", "facing", "north")),
                        ac = new MultiblockBlock(Blocks.WARPED_STAIRS, Map.of("half", "top", "waterlogged", "false", "facing", "east")),
